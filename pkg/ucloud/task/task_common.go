/*=============================================================================
#     FileName: task_common.go
#         Desc: task common
#       Author: ato.ye
#        Email: ato.ye@ucloud.cn
#     HomePage: http://www.ucloud.cn
#      Version: 0.0.1
#   LastChange: 2016-02-15 20:22:07
#      History:
=============================================================================*/
package uftask
...
func taskLog(level string, format string, v ...interface{}) {
	...
	switch level {
	case "DEBUG":
		uflog.DEBUGF(newFormat, v...)
	case "INFO":
		uflog.INFOF(newFormat, v...)
	case "WARN":
		uflog.WARNF(newFormat, v...)
	case "ERROR":
		uflog.ERRORF(newFormat, v...)
	}
}
...
func printRunningTaskStat() {
	table := ufcommon.NewTable([]string{"Type", "Id", "FuncName"})
	// 统计TCP 任务
